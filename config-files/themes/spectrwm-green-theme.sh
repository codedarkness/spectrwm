...
sed -i 's+color_focus_maximized\   =\ rgb:.*+color_focus_maximized\   =\ rgb:22/2D/31+g' $HOME/.config/spectrwm/spectrwm.conf &&
echo " Color focus maximized was change" || echo " Something is broken"
echo ""

## Color Unfocus
sed -i 's+color_unfocus\		=\ rgb:.*+color_unfocus\		=\ rgb:2F/3D/44+g' $HOME/.config/spectrwm/spectrwm.conf &&
echo " Color unfocus was change" || echo " Upsss!!!"
echo ""

## Color Unfocus Maximized
sed -i 's+color_unfocus_maximized\	=\ rgb:.*+color_unfocus_maximized\	=\ rgb:2F/3D/44+g' $HOME/.config/spectrwm/spectrwm.conf &&
echo " Color unfocus maximized was change" || echo " We don't know nothign"
echo ""

## Bar Border Color
sed -i 's+bar_border\[1\]\	    	=\ rgb:.*+bar_border\[1\]\	    	=\ rgb:22/2D/31+g' $HOME/.config/spectrwm/spectrwm.conf &&
echo " Bar border color was change" || echo " Upsss!!!"
echo ""

## Bar Border Unfocus Color
sed -i 's+bar_border_unfocus\[1\]\	=\ rgb:.*+bar_border_unfocus\[1\]\	=\ rgb:22/2D/31+g' $HOME/.config/spectrwm/spectrwm.conf &&
echo " Bar barder color was change" || echo " Do we have a problem"
echo ""

## Bar Background Color
sed -i 's+bar_color\[1\]\	    	=\ rgb:.*+bar_color\[1\]\	    	=\ rgb:22/2D/31+g' $HOME/.config/spectrwm/spectrwm.conf &&
...
sed -i 's/nb="-nb #.*"/nb="-nb #222D31"/g' ~/.config/spectrwm/sysact.sh &&
sed -i 's/sb="-sb #.*"/sb="-sb #222D31"/g' ~/.config/spectrwm/sysact.sh &&
sed -i 's/nf="-nf #.*"/nf="-nf #4D5656"/g' ~/.config/spectrwm/sysact.sh &&
